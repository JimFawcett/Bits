...
/*-------------------------------------------------------------------
  ...
  the insertion operator sends std::vector to standard output.
*/
struct displayParams {
  size_t left = 4;    // number of spaces to indent
...
std::ostream& operator<<(std::ostream& out, std::vector<T>& v) {
  out << "\n" << indent(DisplayParams.left) << "vector";
  out << " {\n";
  out << fold(v, DisplayParams.left + 2, DisplayParams.width);
  out << indent(DisplayParams.left) << "}";
  return out;
}
/*-------------------------------------------------------------------
...
int main() {
 ...
 /* standard library type std::vector<T> */
    ...
    pPoint2->show();
    print(
      "--- pPoint2->coords() = std::vector<double>"
      "{ 1.0, 3.5, -2.0, 42.0 }; ---"
    );
