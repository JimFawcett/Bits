...
/*-----------------------------------------------
  ...
  - Works with any collection with fixed size
    elements.
...
/*-----------------------------------------------
  ...
  - works with any collection with fixed size
    elements that converts to slice.
*/
...
/*-----------------------------------------------
  ...
  - Works with any collection with fixed size
    elements if they provide a Deref to slice,
    e.g. array, Vector
*/
...
/*-----------------------------------------------
  ...
  - looper can't accept string or string ref
